...
public class C05_TestNotasyonu {
    ...
    // bir classîn içinde birden fazla bağımsız çalışabilen test olur mu ?
    // JUnit ile çalışırken class'da birden fazla test olduğunda
    // toplu çalıştırdığımız zaman hangi sıra ile çalışacağını BİLEMEYİZ ve KONTROL EDEMEYİZ
